...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { imagequestion_id: @option.imagequestion_id, option_label: @option.option_label, option_result: @option.option_result }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { imagequestion_id: @option.imagequestion_id, option_label: @option.option_label, option_result: @option.option_result }
    assert_redirected_to option_path(assigns(:option))
  end
